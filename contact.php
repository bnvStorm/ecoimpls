...
<?php include 'includes/head.php';?>
		...
		<main id="main">
			<!-- banner of the page -->
			<section class="banner bg-full overlay" style="background-image: url('images/head/head3.jpg');">
				<div class="container">
					<div class="row">
						<div class="col-xs-12 text-center">
							<h1 class="main-heading3 text-uppercase">Контакты</h1>
					...
					<div class="col-xs-12 col-sm-4">
						...
						<ul class="list-unstyled contact-list">
							<li>
								...
								<address>
									г. Караганда
								   ул. Молокова 100/7 <br>
								   ТОО "ЭкоИмпульс"</address>
							</li>
							<li>
					...
					<div class="col-xs-12 col-sm-8">
						...
						<form action="#" class="contact-form">
							<fieldset>
								...
								<button type="submit" class="btn text-uppercase text-center md-round">Отправить</button>
							</fieldset>
						</form>
					</div>
				</div>
