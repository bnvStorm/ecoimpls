...
<html lang="ru">
<head>
	<title>Прием плат телефонов и планшетов в Караганде на утилизацию - Экоимпульс Караганда</title>
	<meta name="description" content="Принимаем и утилизируем платы телефонов и планшетов в Караганде. Дорого! Прием и утилизация компьютерной и прочей техники по лучшим ценам в Казахстане">
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 text-center">
							<h1 class="main-heading3 text-uppercase">Печатные платы телефонов</h1>
						</div>
					</div>
				</div>
			</section>
					...
					<div class="col-xs-12 col-md-9">
						<div class="holder">
							<div class="img-holder">
								<img src="../../images/staff/pplat/image7.jpg" alt="image description" class="img-responsive">
							</div>
							<div class="txt-holder">
								<h4>Электронные печатные платы 7 группы</h4>
								<strong class="price">Цена за 1 кг - 2500 тг. </strong>
								...
								<p>Электронные печатные платы 7 группы включают в себя: <br>

-Платы мобильных телефонов, планшетов (сенсорные)</p>
<br>
