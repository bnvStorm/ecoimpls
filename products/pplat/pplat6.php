					...
					<div class="col-xs-12 col-md-9">
						<div class="holder">
							<div class="img-holder">
								<img src="../../images/staff/pplat/image6.jpg" alt="image description" class="img-responsive">
							</div>
							<div class="txt-holder">
								<h4>Электронные печатные платы 6 группы</h4>
								<strong class="price">Цена за 1 кг - 3500 тг. </strong>
								...
								<p>Электронные печатные платы 6 группы включают в себя: <br>

- Платы мобильных телефонов кнопочных.</p>
							</div>
						</div>
					</div>
