...
<html lang="ru">
<head>
	<title>Прием меди дорого Караганда Казахстан - Экоимпульс</title>
	<meta name="description" content="Принимаем на утилизацию медные провода в Караганде. Дорого! Прием и утилизация компьютерной и прочей техники по лучшим ценам в Казахстане">
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 text-center">
							<h1 class="main-heading3 text-uppercase">Прием медных проводов</h1>
						</div>
					</div>
				</div>
			</section>
					...
					<div class="col-xs-12 col-md-9">
						<div class="holder">
							...
							<div class="txt-holder">
								...
								<p>Отходы кабельной продукции (медные, шлейфы (IDE), сетевой кабель (UTP), кабель питания).</p>
							</div>
						</div>
					</div>
...
С позолоченными контактами</a></span>
								...
								<li>
									<div class="img-holder">
										<a href="../../products/pplat/pplat4"><img src="../../images/staff/pplat/preview/pimage4.jpg" alt="image description" class="img-responsive"></a>
									</div>
									<div class="txt-holder">
										<div class="header">
