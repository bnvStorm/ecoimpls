...
С позолоченными контактами</a></span>
								...
								<li>
									<div class="img-holder">
										<a href="../../products/ram/ram2.php"><img src="../../images/staff/pplat/preview/pimage1.jpg" alt="image description" class="img-responsive"></a>
									</div>
									<div class="txt-holder">
										<div class="header">
											<span class="name"><a href="../../products/ram/ram2.php">Электронные печатные платы 2 группы</a></span>
