...
<head>
	...
	<meta name="description" content="Принимаем на утилизацию процессоры с пластиковой крышкой в Караганде. Дорого! Прием и утилизация компьютерной и прочей техники по лучшим ценам в Казахстане">
					...
					<div class="col-xs-12 col-md-9">
						<div class="holder">
							<div class="img-holder">
								<img src="../../images/staff/proc/2-2.jpg" alt="image description" class="img-responsive">
							</div>
							<div class="txt-holder">
								<h4>Процессор 2 группы <br>Пластик</h4>
								<strong class="price">Цена за 1 кг - 1500 тг. </strong>
								...
								<p>К процессорам 2 группы относятся процессоры ПК с пластиковой крышкой. </p>
							</div>
						</div>
					</div>
