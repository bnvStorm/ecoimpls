...
Керамика</a></span>
								...
								<li>
									<div class="img-holder">
										<a href="../../products/proc/proc2.php"><img src="../../images/staff/pplat/preview/pimage1.jpg" alt="image description" class="img-responsive"></a>
									</div>
									<div class="txt-holder">
										<div class="header">
											<span class="name"><a href="../../products/proc/proc1.php">Процессор 
...
Пластик</a></span>
								...
								<li>
									<div class="img-holder">
										<a href="../../products/proc/proc3.php"><img src="../../images/staff/pplat/preview/pimage1.jpg" alt="image description" class="img-responsive"></a>
									</div>
									<div class="txt-holder">
										<div class="header">
											<span class="name"><a href="../../products/proc/proc1.php">Процессор
